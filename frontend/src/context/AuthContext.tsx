...
interface AuthContextValue {
  ...
  register: (businessName: string, businessTaxId: string, email: string, password: string) => Promise<void>;
  logout: () => void;
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [business, setBusiness] = useState<Business | null>(() => readStored<Business>("smartreceipt_business"));
  ...
  async function register(businessName: string, businessTaxId: string, email: string, password: string) {
